...
/**
 * Registration command class. It implements command pattern and
...
public class RegistrationCommand implements Command {
	...
	/**
	 * Methods allows to register in the system. User
	 * must enter login, password, repeat this password
	 * correctly, first and last name. If one of the field
	 * is empty the system does not allows the user to 
	 * register.
	 */
	@Override
